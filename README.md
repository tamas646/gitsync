...
## Installation
- You can either [download](https://github.com/tamas646/gitsync/raw/main/gitsync_2.2.0_all.deb) and install the deb package or use the source code and setup it yourself.
